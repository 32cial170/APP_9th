...
$(function () {
  function initialize() {
    ...
    var markerInfos = [
      ...
      {
        position: new google.maps.LatLng(23.568382943785544, 120.3024172782898),
        title: "仁愛眼鏡",
        price: 400,
      },
      {
        position: new google.maps.LatLng(23.56869271045844, 120.30137121677399),
        title: "北港圓環",
        price: 300,
      },
      {
        position: new google.maps.LatLng(23.569646590544906, 120.3018057346344),
        title: "第一銀行",
        price: 300,
      },
      {
    ...
    if (!name1 || name1.length <= 0) name1 = "玩家";
    ...
    $throwDice.click(function () {
      ...
      $runDice.fadeIn(function () {
        for (
          var nStep = Math.floor(Math.random() * 6 + 1);
          nStep == step;
        ...
        setTimeout(function () {
          $runDice.fadeOut(function () {
            user1.goStep(nStep, false, function () {
